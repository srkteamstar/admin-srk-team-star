 ...
 *     fields in the admin drawers — without this file knowing about either.
 *   - The panel renders in a fixed layer attached to <body>. Inside the admin
...
(function () {
    ...
    function enhance(select) {
        ...
        // square admin fields alike — and re-running it is how the enquiries status
    ...
    function start() {
        ...
        new MutationObserver(function (mutations) {
            ...
            // closing the admin drawer replaces its whole innerHTML.
